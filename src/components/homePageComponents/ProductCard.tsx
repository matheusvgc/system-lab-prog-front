...
export default function ProductCard({ product }: Props) {
    ...
    return (
        <div onClick={toProduct} className="justify-self-center max-w-[250px] flex flex-col gap-2 p-4 cursor-pointer rounded-lg border-1 hover:bg-gray-300 text-center">
            <img className="w-[200px] h-[200px] rounded-lg mx-auto object-contain" src={product.productImage} alt="Imagem do produto" />
            <h2 className="text-xl min-h-2 h-[50px]">{product.product?.productName || "undefined"}</h2>
