                ...
                <div className="w-full max-w-7xl py-6 px-4 md:px-10 flex flex-col md:flex-row gap-4 md:gap-10 items-center justify-between text-white">
                    ...
                    <nav className="hidden md:block text-nowrap">
                        <ul className="flex gap-10 items-center">
                            ...
                            </li> : <Stack direction={'row'} alignItems={'center'} gap={5}><UserIcon name={user.username} loading={loading} /> {(userType === 'CUSTOMER') ? <button type="button" className="cursor-pointer" onClick={() => handleLogOut()}>Sair</button> : null} </Stack>}
